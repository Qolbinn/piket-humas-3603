...
import { Loader2, ArrowLeft, Lock, Eye, EyeOff, AlertCircle, CheckCircle2, KeyRound } from 'lucide-react'
    ...
    <div className="min-h-screen grid lg:grid-cols-12 bg-background font-sans">
      ...
      <div className="hidden lg:flex lg:col-span-6 xl:col-span-7 relative bg-gradient-to-br from-[#035b87] via-[#0595d7] to-[#023b59] text-white p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl my-auto py-12">
          ...
          <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight leading-tight mb-6">
            ...
            <span className="text-secondary">Akun Anda</span>
          </h1>

          <p className="text-blue-100 text-base leading-relaxed mb-8">
            Buat kata sandi baru yang kuat dan mudah diingat untuk mengamankan akses akun petugas BPS Kabupaten Tangerang.
          </p>

          <div className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 text-sm text-blue-100 leading-relaxed">
            <p className="font-semibold text-white mb-1">💡 Tips Keamanan Password:</p>
            <p>Gunakan kombinasi minimal 6 karakter dengan variasi huruf, angka, dan simbol.</p>
          </div>
        </div>
      ...
      <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-between p-6 sm:p-10 md:p-12 bg-background relative overflow-y-auto">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-6">
          <div className="mb-8">
            <h2 className="text-3xl font-extrabold tracking-tight text-foreground mb-2">Atur Ulang Password</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="font-bold text-sm">Password Baru</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="font-bold text-sm">Konfirmasi Password</Label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground pointer-events-none" />
                <Input
                  id="confirmPassword"
            ...
            {!successMsg ? (
              ...
              >
                {isPending ? (
                  <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Menyimpan Password...</>
                ) : (
              ...
              <Link href="/login" className="w-full block mt-2">
                <Button className="w-full h-12 text-base font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all rounded-xl">
                  Masuk ke Dashboard
                </Button>
              </Link>
            )}
